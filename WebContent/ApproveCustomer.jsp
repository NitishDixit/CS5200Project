		...
		<center>
			...
			<h:form>
				...
				<h:panelGrid border="1" columns="3">
					<h:outputText value="Enter Customer Id to activate"></h:outputText>
				...
				<h:commandButton value="Activate" type="submit"
					action="#{customerBean.activateCustomer}"></h:commandButton>
